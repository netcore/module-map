        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="identifier" class="form-control" v-model="map.identifier">
                            </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="panel-title">Markers ({{ map.markers.length }})</span>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <span class="panel-title">Polygons ({{ map.polygons.length }})</span>
                            <div class="panel-heading-btn">
